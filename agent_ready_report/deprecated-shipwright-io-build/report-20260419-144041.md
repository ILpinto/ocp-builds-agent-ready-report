...
**Repository**: deprecated-shipwright-io-build
**Path**: `/tmp/claude/repos/deprecated-shipwright-io-build`
**Branch**: `main` | **Commit**: `8c857b66`
**Assessed**: April 19, 2026 at 2:40 PM
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **55.3/100** 🥉 **Bronze** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
| **Attributes Assessed** | 17/29 |
| **Attributes Not Assessed** | 12 |
| **Assessment Duration** | 18.6s |
...
![T2](https://img.shields.io/badge/T2-File_Size_Limits_22--100-red) **File Size Limits** ❌ 22/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 274 huge, 407 large out of 5739 (Threshold: <5% files >500 lines, 0 files >1000 lines)

**Evidence**:
- Found 274 files >1000 lines (4.8% of 5739 files)
...
**Error**: Complexity analysis failed: Subprocess output too large: 13935337 bytes (max: 10000000)
...
- **Repository Snapshot**: 8c857b662e21ac432dec8891dc88cedca61dacf0
- **Assessment Duration**: 18.6s
- **Assessed By**: israelpinto@ipinto-server
- **Assessment Date**: April 19, 2026 at 2:40 PM
