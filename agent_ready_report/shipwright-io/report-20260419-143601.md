...
**Repository**: shipwright-io
**Path**: `/tmp/claude/repos/shipwright-io`
**Branch**: `main` | **Commit**: `b4e31553`
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **20.0/100** ⚠️ **Needs Improvement** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
...
**Measured**: 63 lines, 7 headings, 11 bullets (Threshold: <500 lines, structured format)

**Evidence**:
- README length: 63 lines (excellent)
- Heading density: 11.1 per 100 lines (target: 3-5)
- 11 bullet points, 5 code blocks (concise formatting)
...
- **Repository Snapshot**: b4e315535147110e0cf53a2017f6386dc39184fd
- **Assessment Duration**: 0.0s
