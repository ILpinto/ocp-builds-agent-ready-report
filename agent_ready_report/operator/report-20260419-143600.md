...
**Repository**: operator
**Path**: `/tmp/claude/repos/operator`
**Branch**: `main` | **Commit**: `d1203d7e`
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **49.8/100** 🥉 **Bronze** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
| **Attributes Assessed** | 18/29 |
| **Attributes Not Assessed** | 11 |
| **Assessment Duration** | 0.5s |
...
![T2](https://img.shields.io/badge/T2-File_Size_Limits_24--100-red) **File Size Limits** ❌ 24/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 263 huge, 312 large out of 5717 (Threshold: <5% files >500 lines, 0 files >1000 lines)

**Evidence**:
- Found 263 files >1000 lines (4.6% of 5717 files)
- Largest: vendor/github.com/asaskevich/govalidator/validator.go (1768 lines)
...
![T2](https://img.shields.io/badge/T2-.gitignore_Completeness_89--100-green) **.gitignore Completeness** ✅ 89/100
...
- **Repository Snapshot**: d1203d7ed57ef8cd62fbc3c6ed65d0669a259263
- **Assessment Duration**: 0.5s
