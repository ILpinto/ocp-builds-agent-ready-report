...
**Repository**: samples
**Path**: `/tmp/claude/repos/samples`
**Branch**: `main` | **Commit**: `eb3a6d6b`
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **17.8/100** ⚠️ **Needs Improvement** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
...
![T2](https://img.shields.io/badge/T2-.gitignore_Completeness_57--100-red) **.gitignore Completeness** ❌ 57/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 8/14 patterns (Threshold: ≥70% of language-specific patterns)

**Evidence**:
- .gitignore found (568 bytes)
- Pattern coverage: 8/14 (57%)
...
- **Repository Snapshot**: eb3a6d6b5560b1aa0970d486eb89344a0807047a
- **Assessment Duration**: 0.1s
