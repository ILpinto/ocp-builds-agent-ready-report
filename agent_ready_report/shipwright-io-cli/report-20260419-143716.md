...
**Path**: `/tmp/claude/repos/shipwright-io-cli`
**Branch**: `main` | **Commit**: `e1b4db5a`
**Assessed**: April 19, 2026 at 2:37 PM
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **51.8/100** 🥉 **Bronze** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
...
![T2](https://img.shields.io/badge/T2-.gitignore_Completeness_11--100-red) **.gitignore Completeness** ❌ 11/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 1/9 patterns (Threshold: ≥70% of language-specific patterns)

**Evidence**:
- .gitignore found (43 bytes)
- Pattern coverage: 1/9 (11%)
...
![T2](https://img.shields.io/badge/T2-File_Size_Limits_23--100-red) **File Size Limits** ❌ 23/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 256 huge, 329 large out of 5477 (Threshold: <5% files >500 lines, 0 files >1000 lines)

**Evidence**:
- Found 256 files >1000 lines (4.7% of 5477 files)
- Largest: vendor/cel.dev/expr/checked.pb.go (1231 lines)
...
**Evidence**:
- CI config found: .github/workflows/release.yml, .github/workflows/release-branch.yml, .github/workflows/issues.yml, .github/workflows/verify.yaml, .github/workflows/unit.yaml, .github/workflows/release-notes-linter.yaml, .github/workflows/e2e.yaml, .github/workflows/build-check.yaml
...
- **Repository Snapshot**: e1b4db5ab521ab622979c0aa0d1fdada74f15c97
- **Assessment Duration**: 0.4s
- **Assessed By**: israelpinto@ipinto-server
- **Assessment Date**: April 19, 2026 at 2:37 PM
