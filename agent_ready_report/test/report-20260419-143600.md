...
**Repository**: test
**Path**: `/tmp/claude/repos/test`
**Branch**: `main` | **Commit**: `e71eb2c3`
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **26.9/100** ⚠️ **Needs Improvement** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
...
- **Repository Snapshot**: e71eb2c398cf07920c4a1f94d7a25f14acffc333
- **Assessment Duration**: 0.0s
